    ...
    , m_tabWidget(std::make_unique<QTabWidget>(this))
{
    ...
    if (!AlpmWrapper::instance().initialize())
    {
        QMessageBox::critical(
            this, "Error", "Failed to initialize package manager. Please check your system configuration.");
...
void MainWindow::setupUi()
{
    ...
    connect(m_settingsWidget,
            &SettingsWidget::multilibStatusChanged,
            this,
            [this]()
            {
    ...
    connect(m_settingsWidget,
            &SettingsWidget::chaoticAurStatusChanged,
            this,
            [this]()
            {
                m_searchWidget->updateRepositoryList(m_settingsWidget->isMultilibEnabled(),
...
{
    QStringList styleFiles = { ":/resource/styles/base.qss",
