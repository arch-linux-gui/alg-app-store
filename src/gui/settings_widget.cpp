...
void SettingsWidget::createChaoticAurSettings()
{
    ...
    // Description
    auto* descLabel = new QLabel("Chaotic-AUR provides pre-built AUR packages, making installation faster and easier.\n"
...
void SettingsWidget::createMaintenanceSettings()
{
    ...
    auto* cancelProcessLabel = new QLabel("Kill Running Process:", this);
...
void SettingsWidget::loadCurrentSettings()
{
    ...
    spdlog::info("{}",
                 (QString("Loaded settings: multilib=%1, chaotic-aur=%2")
...
void SettingsWidget::onSetupChaoticClicked()
{
    ...
    connect(process,
            ...
            [this, process](int exitCode, QProcess::ExitStatus exitStatus)
            {
                ...
                spdlog::info("{}",
                             (QString("Chaotic-AUR setup exit code: %1, status: %2")
                                  .arg(exitCode)
                ...
                else
                {
                    ...
                    spdlog::error(
                        "{}",
                        (QString("Failed to install Chaotic-AUR packages. Exit code: %1").arg(exitCode)).toStdString());
                    ...
                    QMessageBox::critical(this, "Error", "Failed to install Chaotic-AUR packages.\n\n" + errorDetails);
                }
            });
...
void SettingsWidget::onRemoveChaoticClicked()
{
    ...
    process->start("pkexec",
                   QStringList() << "pacman" << "-Rns" << "--noconfirm"
...
void SettingsWidget::onCancelProcessClicked()
{
    ...
    msgBox.setInformativeText("This will stop the current installation, uninstallation, or update process.\n\n"
